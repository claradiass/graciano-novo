...
// export default function TelaClienteAtualizar({ setAtualizaLista, route }) {
...
//     navigation.navigate('ClienteLista'); // Substitua 'TelaInicial' pelo nome da sua tela inicial
//   };
